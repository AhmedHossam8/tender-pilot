...
export function AIAnalyticsDashboard({ analysisData, bidData }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Bid Strength Analysis</CardTitle>
        </CardHeader>
        <CardContent>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {market_insights.avg_winning_bid && (
                <div className="p-3 bg-blue-50 rounded-lg">
                  <div className="text-xs text-gray-600">Average Winning Bid</div>
              ...
              {market_insights.avg_timeline && (
                <div className="p-3 bg-purple-50 rounded-lg">
                  <div className="text-xs text-gray-600">Average Timeline</div>
                  <div className="text-xl font-bold text-purple-700">
                    {market_insights.avg_timeline} days
                  </div>
                </div>
              )}
      ...
      <CardContent className="p-6">
        ...
        <div className="mt-3 flex items-center gap-1">
          ...
          <span className={`text-xs font-medium ${trendColors[trend]}`}>
            {trend === 'high' ? 'Excellent' : trend === 'medium' ? 'Good' : 'Needs Work'}
          </span>
        </div>
      </CardContent>
    </Card>
